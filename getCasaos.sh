...
REGION="UNKNOWN"
CASA_DOWNLOAD_DOMAIN="http://gh.halonice.com/https://github.com/"
...
Welcome_Banner() {
    ...
    echo -e "${GREEN_LINE}"
    echo -e ""
    echo -e " ${aCOLOUR[2]}CasaOS Project  : http://gh.halonice.com/https://github.com/IceWhaleTech/CasaOS"
    echo -e " ${aCOLOUR[2]}CasaOS Team     : http://gh.halonice.com/https://github.com/IceWhaleTech/CasaOS#maintainers"
